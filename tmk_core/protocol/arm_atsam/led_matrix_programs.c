...
// White
led_setup_t leds_warm_white[] = {
    {.hs = 0, .he = 100, .rs = 240, .re = 240, .gs = 172, .ge = 172, .bs = 74, .be = 74, .ef = EF_NONE},
    {.end = 1},
};
...
void *led_setups[] = {leds_rainbow_s, leds_rainbow_ns, leds_teal_salmon, leds_yellow, leds_red, leds_green, leds_blue, leds_white, leds_warm_white, leds_white_with_red_stripe, leds_black_with_red_stripe, leds_off};
